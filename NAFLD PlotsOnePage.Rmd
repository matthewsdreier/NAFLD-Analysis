...
minval <- min(cd$Weight[cd$Gender == "Female"], na.rm = FALSE)
maxval <- max(cd$Weight[cd$Gender == "Female"], na.rm = FALSE)

minvalmales <- min(cd$Weight[cd$Gender == "Male"], na.rm = FALSE)
maxvalmales <- max(cd$Weight[cd$Gender == "Male"], na.rm = FALSE)

maxdays <- max(cd$Days[cd$Gender == "Female"], na.rm = FALSE)
maxdaysmales <- max(cd$Days[cd$Gender == "Male"], na.rm = FALSE)
mindays <- min(cd$Days, na.rm = FALSE)
sex <- "Female"
sex2 <- "Male"
